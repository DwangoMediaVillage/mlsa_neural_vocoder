...
from models.parallel_wavegan import Conv1d
...
class ConvInUpsampleNetwork(torch.nn.Module):
    ...
    def __init__(
        ...
        padding = (aux_context_window if use_causal_conv else aux_context_window * 2) // 2
        # NOTE(kan-bayashi): Here do not use padding because the input is already padded
        self.conv_in = Conv1d(
            aux_channels, aux_channels, kernel_size=kernel_size, padding=padding, bias=False
        )
